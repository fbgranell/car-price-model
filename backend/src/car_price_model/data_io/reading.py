import pandas as pd
from car_price_model.utils import list_all_files, get_pyproject_root
...
def read_mapping(column:str) -> dict:
    ...
    """
    import json
    with open(f"{get_pyproject_root()}/src/car_price_model/processing/mappings/{column}.json", 'r') as f:
        return json.load(f)
